                ...
                <View style={styles.main}>
                    <View style={styles.bg}>
                        ...
                        <View style={{flexDirection:'row',justifyContent: 'center',alignItems:'center'}}>
                            <Button title= "contact" onPress={() => navigation.navigate('laywerOne')}/>
                        </View>
                    </View>
                    <View style={styles.bg}>
                        ...
                        <View style={{flexDirection:'row',justifyContent: 'center',alignItems:'center'}}><Button title= "contact" onPress={() => navigation.navigate('laywerOne')}/></View>
                    </View>
